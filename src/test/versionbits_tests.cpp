...
BOOST_AUTO_TEST_CASE(versionbits_test)
{
    ...
    std::unique_ptr<CChainParams> mainnetParamsCtx = std::unique_ptr<CChainParams>(CChainParams::Factory(CBaseChainParams::MAIN, mapArgs));
    const Consensus::Params& mainnetParams = mainnetParamsCtx->GetConsensus();
