...
public:
    explicit SigNetParams(const ArgsManager& args) {
        ...
        consensus.blockscript = CScript(ParseHex(args.GetArg("-signet_blockscript", "512103e464a9f3070da4d3e0b34ce971ff36f3e07c47a8f4beadf32e8ea7e2afa8a82451ae")));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        // 178.128.221.177 DG seed node
        if (gArgs.IsArgSet("-signet_seednode")) {
            const auto seednodes = gArgs.GetArgs("-signet_seednode");
